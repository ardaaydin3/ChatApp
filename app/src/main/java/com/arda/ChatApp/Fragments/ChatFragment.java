package com.arda.ChatApp.Fragments;
...
import com.arda.ChatApp.ChatActivity;
import com.arda.ChatApp.LoginActivity;
import com.arda.ChatApp.contacts;
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                    {
                        if(dataSnapshot.exists())
                        {
                            ...
                            if(dataSnapshot.child("userState").hasChild("state"))
                            {
                                ...
                                {
                                    holder.user_status.setText("Çevrimiçi");
                                }
                                else if(state.equals("offline"))
                                {
                                    holder.user_status.setText("Son Görülme: "+ date +" "+ time);
                                }
                            }
