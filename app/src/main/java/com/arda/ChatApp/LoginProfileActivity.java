...
public class LoginProfileActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data)
    {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE)
        {
            ...
            {
                loadingBar.setTitle("Fotoğraf Yükleniyor");
                                    ...
                                    RootRef.child("Users").child(currentUserID).child("image")
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>()
                                            {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task)
                                                {
                                                    if (task.isSuccessful())
                                                    {
                                                        Toast.makeText(LoginProfileActivity.this, "Başarılı", Toast.LENGTH_SHORT).show();
                                                    }
                                                    else
                                                    {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>()
                    {
                        ...
                        public void onComplete(@NonNull Task<Void> task)
                        {
                            if (task.isSuccessful())
                            {
                                ...
                                Toast.makeText(LoginProfileActivity.this, "Profil Güncellemesi Başarılı", Toast.LENGTH_SHORT).show();
                            }
                            else
                            {
                                String message = task.getException().toString();
        ...
        RootRef.child("Users").child(currentUserID)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                    {
                        ...
                        {
                            Toast.makeText(LoginProfileActivity.this, "Bilgileri Güncelle", Toast.LENGTH_SHORT).show();
                        }
                    }
