...
import com.arda.ChatApp.Notifications.APIService;
import com.arda.ChatApp.Notifications.Client;
import com.arda.ChatApp.Notifications.Data;
import com.arda.ChatApp.Notifications.MyResponse;
import com.arda.ChatApp.Notifications.Sender;
                            ...
                            storageRef.child(messagePushId + "."+ checker).getDownloadUrl()
                                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                                        ...
                                        public void onComplete(@NonNull Task<Uri> task)
                                        {
                                            ...
                                            final File ImageFolder =new File(Environment.getExternalStorageDirectory()+ File.separator+"Dosya"+ File.separator+"Dosya Documents" + File.separator+"Sent");
