...
public class SentRequestActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getSupportActionBar().setTitle("Mesaj İstekleri");
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                    {
                        if(dataSnapshot.exists())
                        {
                            ...
                            if(type.equals("sent"))
                            {
                                ...
                                request_sent_btn.setText("İptal");
                                ...
                                UsersRef.child(ListUserID).addValueEventListener(new ValueEventListener()
                                {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                                    {
                                        ...
                                        holder.userStatus.setText("İstek Gönderdi");
        ...
        ChatRequestRef.child(ListUserID).child(currentUserID)
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>()
                {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        if (task.isSuccessful())
                        {
                            Toast.makeText(SentRequestActivity.this, "İsteği İptal Ettin...", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
