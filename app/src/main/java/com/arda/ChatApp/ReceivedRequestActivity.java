...
public class ReceivedRequestActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getSupportActionBar().setTitle("İstekler");
...
//        currentUserID = mAuth.getCurrentUser().getUid();
    ...
    protected void onResume() {
        ...
        MainActivity.UpdateUserStatus("Çevrimiçi");
    ...
    protected void onPause() {
        ...
        MainActivity.UpdateUserStatus("Çevrimdışı");
    }
                            ...
                            if(type.equals("received"))
                            {
                                ...
                                UsersRef.child(ListUserID).addValueEventListener(new ValueEventListener()
                                {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                                    {
                                        ...
                                        holder.userStatus.setText("Seninle İletişime Geçmek İstiyor");
                                        ...
                                        holder.itemView.setOnClickListener(v -> {
                                            ...
                                            builder.setTitle(requestUserName + " Mesaj İsteği");
                                                    ...
                                                    ChatRequestRef.child(ListUserID).child(currentUserID)
                                                            ...
                                                            .addOnCompleteListener(new OnCompleteListener<Void>()
                                                            {
                                                                ...
                                                                public void onComplete(@NonNull Task<Void> task)
                                                                {
                                                                    if (task.isSuccessful())
                                                                    {
                                                                        Toast.makeText(ReceivedRequestActivity.this, "Kaydedildi..", Toast.LENGTH_SHORT).show();
                                                                    }
                                                                }
                                                            });
                                                }
