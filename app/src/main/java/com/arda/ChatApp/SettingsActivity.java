...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void InitializeFields()
    {
        ...
        getSupportActionBar().setTitle("Profil Güncelleme");
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data)
    {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE)
        {
            ...
            if (resultCode == RESULT_OK)
            {
                ...
                loadingBar.setMessage("Lütfen Bekleyin, Profil fotoğrafınız güncelleniyor");
                                ...
                                RootRef.child("Users").child(currentUserID).child("image")
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>()
                                        {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task)
                                            {
                                                ...
                                                {
                                                    Toast.makeText(SettingsActivity.this, "Başarılı", Toast.LENGTH_SHORT).show();
                                                }
                                                else
                                                {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>()
                    {
                        ...
                        public void onComplete(@NonNull Task<Void> task)
                        {
                            if (task.isSuccessful())
                            {
                                ...
                                Toast.makeText(SettingsActivity.this, "Profil Güncelleme Başarılı", Toast.LENGTH_SHORT).show();
                            }
                            else
                            {
                                String message = task.getException().toString();
